package com.curso.api.config.security.authorization;
...
import com.curso.api.persistence.repositories.security.IOperationRepository;
...
public class CustomAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
    ...
    private boolean isPublic(String url, String httpMethod) {
        List<Operation> publicAccessEndpoints = operationRepository.findByPubliccAcces();
